...
public enum LogMessage {
    ...
    TRY_GET_ALL_PRODUCTS_ADMIN("Попытка получения всех продуктов с сортировкой по статусу, админ."),
    TRY_GET_ALL_PRODUCTS_SELLER("Попытка получения всех продуктов с сортировкой по статусу, продавец."),
