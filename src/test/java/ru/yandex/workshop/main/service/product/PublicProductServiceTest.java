...
//        ProductsSearchRequestDto productsSearchRequestDto = new ProductsSearchRequestDto();
//        productsSearchRequestDto.setCategories(List.of(1L, 2L));
//
//        Predicate predicate = getPredicate(productsSearchRequestDto);
...
//        ProductsSearchRequestDto productsSearchRequestDto = new ProductsSearchRequestDto();
//        productsSearchRequestDto.setVendorIds(List.of(1L, 2L));
//
//        Predicate predicate = getPredicate(productsSearchRequestDto);
//        Sort sortBy = Sort.by("productionTime").descending();
//        PageRequest pageRequest = PageRequestOverride.of(0, 10, sortBy);
...
//        ProductsSearchRequestDto productsSearchRequestDto = new ProductsSearchRequestDto();
//        productsSearchRequestDto.setText("description and details");
//
//        Predicate predicate = getPredicate(productsSearchRequestDto);
//        Sort sortBy = Sort.by("productionTime").descending();
//        PageRequest pageRequest = PageRequestOverride.of(0, 10, sortBy);
...
//        ProductsSearchRequestDto productsSearchRequestDto = new ProductsSearchRequestDto();
//        productsSearchRequestDto.setCategories(List.of(2L));
//        productsSearchRequestDto.setVendorIds(List.of(2L));
//
//        Predicate predicate = getPredicate(productsSearchRequestDto);
//        Sort sortBy = Sort.by("productionTime").descending();
//        PageRequest pageRequest = PageRequestOverride.of(0, 10, sortBy);
...
//        ProductsSearchRequestDto productsSearchRequestDto = new ProductsSearchRequestDto();
//        productsSearchRequestDto.setIsRussian(true);
//
//        Predicate predicate = getPredicate(productsSearchRequestDto);
//        Sort sortBy = Sort.by("productionTime").descending();
//        PageRequest pageRequest = PageRequestOverride.of(0, 10, sortBy);
...
//        ProductsSearchRequestDto productsSearchRequestDto = new ProductsSearchRequestDto();
//        productsSearchRequestDto.setIsRussian(false);
//
//        Predicate predicate = getPredicate(productsSearchRequestDto);
//        Sort sortBy = Sort.by("productionTime").descending();
//        PageRequest pageRequest = PageRequestOverride.of(0, 10, sortBy);
...
//        ProductsSearchRequestDto productsSearchRequestDto = new ProductsSearchRequestDto();
//        productsSearchRequestDto.setText("foo");
//        productsSearchRequestDto.setSellerIds(List.of(3L));
//        productsSearchRequestDto.setVendorIds(List.of(4L));
//        productsSearchRequestDto.setCategories(List.of(5L));
//        productsSearchRequestDto.setIsRussian(true);
//
//        Predicate predicate = getPredicate(productsSearchRequestDto);
//        Sort sortBy = Sort.by("productionTime").descending();
...
//        ProductsSearchRequestDto productsSearchRequestDto = new ProductsSearchRequestDto();
//        productsSearchRequestDto.setPriceMin(1000F);
//        productsSearchRequestDto.setPriceMax(2000F);
//
//        Predicate predicate = getPredicate(productsSearchRequestDto);
//        Sort sortBy = Sort.by("price").ascending();
//        PageRequest pageRequest = PageRequestOverride.of(0, 10, sortBy);
...
//        ProductsSearchRequestDto productsSearchRequestDto = new ProductsSearchRequestDto();
//        productsSearchRequestDto.setPriceMax(450F);
//
//        Predicate predicate = getPredicate(productsSearchRequestDto);
//        Sort sortBy = Sort.by("productionTime").descending();
//        PageRequest pageRequest = PageRequestOverride.of(0, 10, sortBy);
...
//        ProductsSearchRequestDto productsSearchRequestDto = new ProductsSearchRequestDto();
//        productsSearchRequestDto.setPriceMin(2000F);
//
//        Predicate predicate = getPredicate(productsSearchRequestDto);
//        Sort sortBy = Sort.by("productionTime").descending();
//        PageRequest pageRequest = PageRequestOverride.of(0, 10, sortBy);
...
//    }
//
//    private Predicate getPredicate(ProductsSearchRequestDto productsSearchRequestDto) {
