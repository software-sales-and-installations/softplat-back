...
class ImageControllerTest {
    ...
    void shouldAddImageToVendor() {
        ...
        MvcResult result = mockMvc.perform(multipart(
                "http://localhost:8080/admin/vendor/{vendorId}/image", vendorId)
                        .file(multipartFile)
    ...
    void shouldAddImageToSeller() {
        ...
        MvcResult result = mockMvc.perform(multipart(
                        "http://localhost:8080/seller/account/{email}/image", sellerEmail)
                        .file(multipartFile)
                        .contentType(MediaType.MULTIPART_FORM_DATA))
                .andExpect(status().isOk())
                .andReturn();
    ...
    void shouldAddProductImage() {
        ...
        MvcResult result = mockMvc.perform(multipart(
                        "http://localhost:8080/seller/{sellerId}/product/{productId}/image", sellerId, productId)
                        .file(multipartFile)
                        .contentType(MediaType.MULTIPART_FORM_DATA))
                .andExpect(status().isOk())
                .andReturn();
