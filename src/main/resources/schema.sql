DROP TABLE IF EXISTS buyers,sellers,admins,categories,licenses,vendors,countries,images,baskets,orders,statistics,
    products, requisites, product_basket, product_order CASCADE;
